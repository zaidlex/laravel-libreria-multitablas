...
class LibroController extends Controller
{
    ...
    {
        $libros = Libro::paginate();
        //                      Nombre vista    variable
        $pdf = PDF::loadView('libro.pdf', ['libros'=>$libros]);
        // para visualizar el documento en la web
        return $pdf->stream(); //crear la carpeta fonts en storage

        //para que el documento se descargue automaticamente
        //return $pdf->download('nombre.pdf');

        //probar el direccionamiento o la estructura pdf
